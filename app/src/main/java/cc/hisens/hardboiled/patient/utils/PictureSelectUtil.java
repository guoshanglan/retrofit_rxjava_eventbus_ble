...
public class PictureSelectUtil {
    ...
    //打开相册选择图片
    public  static void OpenPicture(Context context,int maxSelect,boolean isShow){
        ...
        PictureSelector.create((Activity) context)
                ...
                .glideOverride(80,80)// int glide 加载宽高，越小图片列表越流畅，但会影响列表图片浏览的清晰度
    ...
    //打开相册选择图片
    public  static void OpenPicture2(Context context,int maxSelect,boolean isShow){
