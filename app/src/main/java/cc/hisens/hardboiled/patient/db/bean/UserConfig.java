...
public class UserConfig {
    ...
    public static class UserInfo {
        ...
        public static void setMonitorType(String type){
            sharedUtils.writeString(Appconfig.MonitorType, type);
        }
        public static void setMonitorTag(String tag){
            sharedUtils.writeString(Appconfig.AVSSTAG, tag);
        }
        public static String getMonitorType(){

            return sharedUtils.readString(Appconfig.MonitorType);
        }
        public static String getTag(){
            return sharedUtils.readString(Appconfig.AVSSTAG);
        }
