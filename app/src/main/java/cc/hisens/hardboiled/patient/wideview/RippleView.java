...
public class RippleView extends View {
    ...
    private void init() {
        ...
        mPaint.setStrokeWidth(ScreenUtils.dip2px(mContext, 2));
        if (mIsFill) {
        ...
        mDensity = ScreenUtils.dip2px(mContext, mDensity);
    ...
    private void drawInCircle(Canvas canvas) {
        ...
        if (mRipples.size() > 0) {
            // 控制第二个圆出来的间距
            if (mRipples.get(mRipples.size() - 1).width > ScreenUtils.dip2px(mContext, mDensity)) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (myWidthSpecMode == MeasureSpec.EXACTLY) {
            ...
            // wrap_content
            mWidth = ScreenUtils.dip2px(mContext, 120);
        }
        ...
        if (myHeightSpecMode == MeasureSpec.EXACTLY) {
            ...
            // wrap_content
            mHeight = ScreenUtils.dip2px(mContext, 120);
        }
